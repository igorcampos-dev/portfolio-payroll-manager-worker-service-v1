...
### `GET /tech-spring-solutions/v1/employee/paycheck`
...
### `POST /tech-spring-solutions/v1/admin/paycheck`
...
### `PUT /tech-spring-solutions/v1/admin/paycheck`
...
### `DELETE /tech-spring-solutions/v1/admin/paycheck`
